globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/annapushnikova/Projects/chatbot/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { createFetch as createFetch$1, Headers } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/annapushnikova/Projects/chatbot/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/annapushnikova/Projects/chatbot/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/annapushnikova/Projects/chatbot","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/annapushnikova/Projects/chatbot/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/annapushnikova/Projects/chatbot/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/annapushnikova/Projects/chatbot/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_49TISG = () => Promise.resolve().then(function () { return ai_post$1; });
const _lazy_OdVb04 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/ai', handler: _lazy_49TISG, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_OdVb04, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OdVb04, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/annapushnikova/Projects/chatbot/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
